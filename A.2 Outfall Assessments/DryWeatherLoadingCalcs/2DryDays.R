...
dry_days_year$MonitoringYear<- ifelse(dry_days_year$Date>(as.Date("2021-09-30", origin="1900-01-01")) & dry_days_year$Date<(as.Date("2022-10-01", origin="1900-01-01")), "MY2021-22",
